...
const CardMenuItem = [
    {
        text: 'Комментарии',
        img: <svg className={styles.menuItemImage} width="100%" height="100%" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        text: 'Поделиться',
        img: <svg className={styles.menuItemImage} width="100%" height="100%" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        text: 'Скрыть',
        img: <svg className={styles.menuItemImage} width="100%" height="100%" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        text: 'Пожаловаться',
        img: <svg className={styles.menuItemImage} width="100%" height="100%" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
